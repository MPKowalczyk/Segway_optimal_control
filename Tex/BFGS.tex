...
\end{enumerate}
W celu wyznaczenia nowego kierunku poszukiwań rozwiązywany jest układ równań (\ref{eq:bfgss}). Dzięki takiemu podejściu uniknięto odwracania macierzy \textit{W}.
