...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=2.8in]{Figures/equ_pos.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/equ_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/equ_ang.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/equ_ang_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/equ_pen.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/equ_con.eps}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=2.8in]{Figures/zero_pos.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/zero_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/zero_ang.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/zero_ang_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/zero_pen.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/zero_con.eps}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=2.8in]{Figures/stab_pos.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/stab_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/stab_ang.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/stab_ang_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/stab_pen.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/stab_con.eps}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=2.8in]{Figures/exp1/pos.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/exp1/vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/exp1/ang.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/exp1/ang_vel.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/exp1/pen.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/exp1/control.eps}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=2.8in]{Figures/exp2/hard_pos3.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/exp2/hard_vel3.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/exp2/hard_ang_vel3.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/exp2/hard_ang3.eps}}
	
	\subfloat{\includegraphics[width=2.8in]{Figures/exp2/hard_pen3.eps}}
	~~
	\subfloat{\includegraphics[width=2.8in]{Figures/exp2/hard_con3.eps}}
	\caption{Zadanie stabilizacji obiektu w punkcie równowagi.}
	\label{fig:equPen}
\end{figure}
