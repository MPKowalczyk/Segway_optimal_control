...
%% Wyliczenie Psi
[trk,xrk] = rk4_row_pen(@rownania_penalty,x0,Tsim,1/fs,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,fi_max,K,@(s) 0);
figure(1);
plot(trk,xrk(:,2));
psiT = xrk(end,:)';
[tpsi, psi] = rk4_psi(@rownania_psi,xrk,psiT,Tsim,1/fs,c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,fi_max,K,@(s) 0);
figure(2);
plot(tpsi,psi(:,2));
roznica = dQ - psi(1,:)'